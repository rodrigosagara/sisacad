...
<div class="container">
    <h4>Alunos</h4>
    <div class="row">
        <form action="{{url('painel/aluno/novo')}}" method="post" novalidate>
            @csrf
          <div class="input-field col s12 l4">
            <input type="text" name="nome_completo" id="nome_completo" class="validate" required>
          ...
          <div class="input-field col s12 l4">
            <input type="text" id="cadeira" name="cadeira" class="validate">
          ...
          <div class="row">
            ...
            <div class="row">
                <div class="input-field col s12 l4">
                <input type="number" id="autocomplete-input" class="autocomplete" name="turma" id="turma" placeholder="id da turma">
